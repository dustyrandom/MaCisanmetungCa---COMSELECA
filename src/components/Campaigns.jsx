    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="pt-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          <h1 className="text-2xl sm:text-3xl font-bold text-red-900">Campaign</h1>
          <p className="text-sm sm:text-base text-gray-600 mt-1 mb-8">Campaign materials from candidates.</p>
