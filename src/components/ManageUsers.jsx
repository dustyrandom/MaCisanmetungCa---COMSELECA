...
function ManageUsers() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg shadow-lg p-6 w-full max-w-md max-h-[80vh] overflow-y-auto">
            ...
            <div className="mt-5 flex justify-end space-x-3">
              ...
              <button
                onClick={() => setShowSavePasswordConfirm(true)} // instead of handleSave()
      ...
      {showSavePasswordConfirm && (
        <div className="fixed inset-0 flex items-center justify-center bg-black/50 z-50">
          <div className="bg-white rounded-lg shadow-lg p-6 max-w-md w-full border border-gray-200">
            <h3 className="text-lg font-semibold text-gray-900 mb-3">Confirm Save</h3>
            <p className="text-gray-600 mb-4 text-sm">
              To save changes for 
              <span className="font-semibold text-gray-900"> {editData.firstName} {editData.lastName}</span>, 
              please enter your admin password.
            </p>
